    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.secondary }]} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.bottomCard, { backgroundColor: colors.background }]}>
          <Text style={[styles.bottomCardTitle, { color: colors.text, fontSize: 32 * scale }]}>Appearance</Text>
          <Text style={[styles.bottomCardSub, { color: colors.textSecondary, fontSize: 14 * scale }]}>How would you like Havenly to look?</Text>
          ...
          <View style={styles.optionsContainer}>
            <TouchableOpacity 
              ...
              onPress={() => handleUpdate({ appearance: 'light' })}
              activeOpacity={0.7}
            >
              <Svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={settings.appearance === 'light' ? colors.background : colors.text} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <Path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
              </Svg>
              <Text style={[styles.optionBtnText, { color: settings.appearance === 'light' ? colors.background : colors.text }]}>Light</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              ...
              onPress={() => handleUpdate({ appearance: 'dark' })}
              activeOpacity={0.7}
            >
              <Svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={settings.appearance === 'dark' ? colors.background : colors.text} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <Path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
              </Svg>
              <Text style={[styles.optionBtnText, { color: settings.appearance === 'dark' ? colors.background : colors.text }]}>Dark</Text>
            </TouchableOpacity>
          </View>
