...
export default function FocusModePage() {
  ...
  const { hours, minutes, seconds } = useGlobalSearchParams<{ hours?: string, minutes?: string, seconds?: string }>();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.timerContainer}>
          <RoomTimer initialSeconds={initialTotalSeconds} autoStart={false} onFinish={handleFinish} />
        </View>
