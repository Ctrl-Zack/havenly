      ...
      <View style={[styles.sheet, { backgroundColor: colors.background }]}>
        ...
        >
          <View style={styles.header}>
            <Text style={[styles.title, { color: colors.text, fontSize: 32 * scale }]}>Focus Rooms</Text>
            <Text style={[styles.subtitle, { color: colors.textSecondary, fontSize: 14 * scale }]}>Work silently alongside others.</Text>
          </View>
