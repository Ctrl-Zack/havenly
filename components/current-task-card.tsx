    ...
    <div className="relative z-0 w-full max-w-[400px] mb-12">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-[#b4c3fb] p-7 text-black shadow-lg">
        ...
        <div className="relative z-10 flex flex-col gap-5">
          {/* Flag Icon */}
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#a5b5f2]">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex flex-col items-start gap-3">
              <h3 className="font-serif text-xl font-bold tracking-tight text-black">
                Currently In Progress
              </h3>
              
              <div className="rounded-full bg-[#ced8fa] px-4 py-1.5">
              ...
              <p className="mt-1 text-sm text-black/90">
                <span className="font-extrabold">Estimated:</span> <span className="font-medium">45 mins</span>
              </p>
            </div>
