    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.secondary }]} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.bottomCard, { backgroundColor: colors.background }]}>
          <Text style={[styles.bottomCardTitle, { color: colors.text, fontSize: 32 * scale }]}>Animation</Text>
          <Text style={[styles.bottomCardSub, { color: colors.textSecondary, fontSize: 14 * scale }]}>Some motion can be distracting.</Text>
          ...
          <View style={styles.optionsContainer}>
            <TouchableOpacity 
              ...
              onPress={() => handleUpdate({ animation: 'full' })}
              activeOpacity={0.7}
            >
              {/* Motion/Speed icon — horizontal lines with circle */}
              <Svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={settings.animation === 'full' ? colors.background : colors.text} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <Path d="M5 12h14" />
                <Path d="M5 8h8" />
                <Path d="M5 16h8" />
                <Circle cx="19" cy="12" r="3" fill={settings.animation === 'full' ? colors.background : colors.text} />
              </Svg>
              <Text style={[styles.optionBtnText, { color: settings.animation === 'full' ? colors.background : colors.text }]}>Full</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              ...
              onPress={() => handleUpdate({ animation: 'reduced' })}
              activeOpacity={0.7}
            >
              {/* Static/Record icon — circle with inner dot */}
              <Svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={settings.animation === 'reduced' ? colors.background : colors.text} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <Circle cx="12" cy="12" r="10" />
                <Circle cx="12" cy="12" r="4" fill={settings.animation === 'reduced' ? colors.background : colors.text} />
              </Svg>
              <Text style={[styles.optionBtnText, { color: settings.animation === 'reduced' ? colors.background : colors.text }]}>Reduced</Text>
            </TouchableOpacity>
          </View>
