      ...
      <View style={styles.card}>
        ...
        <View style={styles.header}>
          <View style={styles.titleContainer}>
            <Text style={styles.title} numberOfLines={2}>{taskInfo?.title || 'Task Details'}</Text>
            <Text style={styles.subtitle}>{taskInfo?.subtitle || 'You only need to do the first one.'}</Text>
          </View>
          <TouchableOpacity
        ...
        <ScrollView style={{ width: '100%' }} contentContainerStyle={styles.taskList} showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text style={styles.startText}>Start First Step</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
