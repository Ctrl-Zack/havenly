    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.secondary }]} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.bottomCard, { backgroundColor: colors.background }]}>
          <Text style={[styles.bottomCardTitle, { color: colors.text, fontSize: 32 * scale }]}>Text Size</Text>
          <Text style={[styles.bottomCardSub, { color: colors.textSecondary, fontSize: 14 * scale }]}>Find a comfortable reading size.</Text>
          ...
          <View style={styles.optionsContainer}>
            <TouchableOpacity
              ...
              onPress={() => handleUpdate({ textSize: 'small' })}
              activeOpacity={0.7}
            >
              <Text style={[styles.optionIcon, { color: settings.textSize === 'small' ? colors.background : colors.text, fontSize: 16 }]}>T</Text>
              <Text style={[styles.optionBtnText, { color: settings.textSize === 'small' ? colors.background : colors.text }]}>Small</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleUpdate({ textSize: 'regular' })}
              activeOpacity={0.7}
            >
              <Text style={[styles.optionIcon, { color: settings.textSize === 'regular' ? colors.background : colors.text, fontSize: 20 }]}>T</Text>
              <Text style={[styles.optionBtnText, { color: settings.textSize === 'regular' ? colors.background : colors.text }]}>Regular</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleUpdate({ textSize: 'large' })}
              activeOpacity={0.7}
            >
              <Text style={[styles.optionIcon, { color: settings.textSize === 'large' ? colors.background : colors.text, fontSize: 24 }]}>T</Text>
              <Text style={[styles.optionBtnText, { color: settings.textSize === 'large' ? colors.background : colors.text }]}>Large</Text>
            </TouchableOpacity>
          </View>
