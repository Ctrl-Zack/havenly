...
export function CompletedTaskCard() {
  return (
    <div className="relative z-0 w-full max-w-[400px] mb-12">
      {/* Main Card */}
      <div className="relative overflow-hidden rounded-[2.5rem] bg-[#b4c3fb] p-7 text-black shadow-lg">
        {/* Decorative Background Swirls (Abstract Shapes) */}
        <div className="absolute right-0 top-0 h-[190px] w-[249px] pointer-events-none z-0">
        ...
        <div className="relative z-10 flex flex-col gap-4">
          {/* Flag Icon */}
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#a5b5f2]">
            <svg
              width="22"
              height="22"
              viewBox="0 0 24 24"
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex flex-col items-start gap-1">
              <h3 className="font-serif text-[26px] font-bold tracking-tight text-black leading-tight">
                You&apos;re on a roll!
              </h3>
              
              <p className="mt-1 text-[15px] font-medium text-black/80">
                You&apos;ve completed your last task.
              </p>
              
              <div className="mt-2 flex items-center gap-2">
                <span className="font-bold text-[14px]">Next Task:</span>
                <div className="rounded-full bg-[#ced8fa] px-3 py-1">
      ...
      <div className="absolute bottom-1 right-10 -z-10 translate-y-full">
        <div className="rounded-b-2xl bg-[#4b9682] px-6 pb-2 pt-4">
          <button
            type="button"
